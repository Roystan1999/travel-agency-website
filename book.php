        ...
        <div class="container">
            <div class="row">
                ...
                <div class="hotel-entry">
                  <a href="hotel-room.html" class="hotel-img" style="background-image: url(imagess/taj.jpg);">
                    <p class="price"><span>$120</span><small> /night</small></p> 
                  </a>
                  <div class="desc">
                    <p class="star"><span><i class="icon-star-full"></i><i class="icon-star-full"></i><i class="icon-star-full"></i><i class="icon-star-full"></i><i class="icon-star-full"></i></span> 545 Reviews</p>
                    <h3><a href="hotel-room.html">AGRA</a></h3>
                    <span class="place">New York, USA</span>
                    <p><ul><li>Two double beds</li>
                      <li>babysitting facilities</li><li>1 free bed available on request</li></ul></p>
                  </div>
                </div>
